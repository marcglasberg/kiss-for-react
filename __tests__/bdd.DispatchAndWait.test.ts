...
import { ActionStatus, KissAction, Store, UserException } from '../src';
...
class IncrementSyncBeforeFails extends KissAction<State> {
...
class IncrementSyncReduceFails extends KissAction<State> {
...
class IncrementSyncAfterFails extends KissAction<State> {
...
class IncrementAsyncBeforeFails extends KissAction<State> {
...
class IncrementAsyncReduceFails extends KissAction<State> {
...
class IncrementAsyncAfterFails extends KissAction<State> {
