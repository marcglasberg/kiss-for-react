...
import { Store, KissAction, StoreException } from '../src';
...
class IncrementAsyncBefore extends KissAction<State> {
...
class IncrementAsyncReduce extends KissAction<State> {
...
class IncrementAsyncBeforeReduce extends KissAction<State> {
