...
class IncrementAction extends KissAction<State> {
  reduce() {
...
class DelayedAction extends KissAction<State> {
...
class AnotherDelayedAction extends KissAction<State> {
...
class YetAnotherDelayedAction extends KissAction<State> {
