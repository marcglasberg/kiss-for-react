...
class StartAddingAsync extends KissAction<State> {
...
class Add20Async extends KissAction<State> {
...
class Add19Sync extends KissAction<State> {
...
class ResetSync extends KissAction<State> {
